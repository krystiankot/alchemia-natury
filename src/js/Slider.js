  ...
  changeSlide = index => {
    ...
    this.slides.forEach((slide, index) => {
      if (index < this.currentSlide) {
        if (this.currentSlide == this.slides.length - 1 && index == 0)
          slide.classList.add("slider__slide--moved-right");
        else slide.classList.add("slider__slide--moved-left");
      } else if (index > this.currentSlide) {
        if (this.currentSlide == 0 && index == this.slides.length - 1)
          slide.classList.add("slider__slide--moved-left");
